...
CreateThread(function()
    print("MD HUD has loaded successfully. more at https://md-dev.store")
    while ESX == nil do
...
CreateThread(function()
    ...
    SetMinimapComponentPosition("minimap", "L", "B", 0.0, -0.022, 0.160, 0.220)
    SetMinimapComponentPosition("minimap_mask", "L", "B", 1, 1, 0.160, 0.220)
    SetMinimapComponentPosition("minimap_blur", "L", "B", -0.029, 0.002, 0.286, 0.267)
